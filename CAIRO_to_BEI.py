...
# Open Momondo Flight Search Page (Cairo to Beirut)
url = "https://www.momondo.com/flight-search/CAI-BEY/2025-12-01/2026-02-28?ucs=1dr53qh&sort=bestflight_a"
driver.get(url)
...
# Set a limit for "Show More" button clicks
for i in range(3):
    try:
...
df.to_csv("CAIRO_to_BEI_momondo_prices.csv", index=False)  # Save to a CSV file in Colab
print(df)
print("Scraping completed! Prices saved in CAIRO_to_BEI_momondo_prices.csv.")