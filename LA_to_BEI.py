...
# Open Momondo Flight Search Page (LA to Beirut)
url = "https://www.momondo.com/flight-search/LAX-BEY/2025-12-01/2026-02-28?ucs=3261as&sort=bestflight_a"
driver.get(url)
...
df.to_csv("LA_to_BEI_momondo_prices.csv", index=False)  # Save to a CSV file in Colab
print(df)
print("Scraping completed! Prices saved in LA_to_BEI_momondo_prices.csv")