...
# Open Momondo Flight Search Page (Paris to Beirut)
url = "https://www.momondo.com/flight-search/PAR-BEY/2025-12-01/2026-02-28?ucs=1xdidg9&sort=bestflight_a"
driver.get(url)
...
df.to_csv("PAR_to_BEI_momondo_prices.csv", index=False)  # Save to a CSV file in Colab
print(df)
print("Scraping completed! Prices saved in PAR_to_BEI_momondo_prices.csv")